...
export default function HRPostDetails({ post, department }) {
    const basicItems = [
        {
            key: '1',
            label: '投递时间',
    ...
    return <div>
        <Row justify="center">
            <div>
                <Title style={{display: "flex", textAlign: "center", fontSize: "30px", align: 'center', justifyContent: 'center'}}> {post.postName} </Title>
